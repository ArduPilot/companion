...
# udpAPM = UDPEndpoint('192.168.2.1', 14550, 'udpAPM')
# serialAPM = SerialEndpoint('/dev/ttyACM0', 115200, 'serialAPM')
# 
# serialAPM.add_endpoint(udpAPM)
# udpAPM.add_endpoint(serialAPM)
# 
# udpPing = UDPEndpoint('192.168.2.2', 8989, 'udpPing')
# serialPing = SerialEndpoint('/dev/ttyUSB0', 115200, 'serialPing')
# 
# udpPing.add_endpoint(serialPing)
# serialPing.add_endpoint(udpPing)
# 
# 
# 
# outputs = [udpAPM, serialAPM, udpPing, serialPing]
# 
# while True:
